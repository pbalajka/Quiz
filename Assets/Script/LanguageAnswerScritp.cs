...
public class LanguageAnswerScritp : MonoBehaviour {
	//Anglictina odpovede
	private static string answer1ENG = "laska";
	private static string answer2ENG = "placer";
	private static string answer3ENG = "felicità";
	private static string answer4ENG = "beleza";
	private static string answer5ENG = "надеюсь";
	private static string answer6ENG = "esthétique";
	private static string answer7ENG = "pekny";
	private static string answer8ENG = "amo il";
	private static string answer9ENG = "te amo";
	private static string answer10ENG = "bog";
